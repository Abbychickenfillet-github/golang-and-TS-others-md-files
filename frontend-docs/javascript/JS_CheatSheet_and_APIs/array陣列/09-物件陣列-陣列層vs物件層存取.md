...
> 相關：[[03-map-轉換陣列重點與練習]]、[[02-陣列遍歷-forEach與callback]]、[[Object靜態方法速查]]
...
> 這條接回 [[02-陣列遍歷-forEach與callback]] 的「逐句拆解」段落。
...
詳見 [[02-陣列遍歷-forEach與callback]] 的「callback 會自動收到 3 個參數」。
...
| 筆記 | 關聯原因 |
| --- | --- |
| [[02-陣列遍歷-forEach與callback]] | 括號斷句與三個參數的完整說明在那篇 |
